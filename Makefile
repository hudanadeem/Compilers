...
clean:
	rm -f parser.java Lexer.java sym.java *.class absyn/*.class tests/*.sym tests/*.abs tests/12345_C1/*.sym tests/12345_C1/*.abs tests/given_tests_C1/*.sym tests/given_tests_C1/*.abs tests/given_tests_C2/*.sym tests/given_tests_C1/*.abs *~